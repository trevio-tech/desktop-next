<template>
  <div class="p-4 rounded-lg flex flex-col flex-1 shadow-sm border border-sky-200 bg-gradient-to-r from-sky-200 to-indigo-200 hover:shadow-md transition-shadow">
    ...
    <footer class="mt-auto text-center">
      ...
      <div v-if="tariff.discount > 0" class="text-pink-500 font-medium text-sm">
        Новая цена {{ tariff.total_price }}
      </div>
      <div class="text-2xl font-bold mt-2 mb-6">{{ tariff.period_value }} {{ tariff.period_text }}</div>
